...
//In the call to higherOrderFunction, modify the callback function expression. The new function expression 
//should log the square of the number to the console.
higherOrderFunction(5, function(num) {
    console.log(num**2);
});


//In the call to higherOrderFunction, modify the callback function expression that takes two parameters, 
//num1 and num2, and log their sum to the console. Make the necessary changes to higherOrderFunction to call 
//the callback accordingly.
// higherOrderFunction(5,10, function(num1,num2) {
